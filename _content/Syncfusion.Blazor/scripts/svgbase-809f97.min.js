  ...
  function findDirection(rX, rY, rect, arrowLocation, arrowPadding, top, bottom, left, tipX, tipY) {
    ...
    if (top) {
      ...
      if (arrowLocation.x - arrowPadding > startX) {
        direction = direction.concat(' L' + ' ' + (arrowLocation.x - arrowPadding) + ' ' + height + ' L' + ' ' + (startX + rX) + ' ' + height + ' Q ' + startX + ' ' + height + ' ' + startX + ' ' + (height - rY) + ' z');
      } else {
        if (arrowPadding === 0) {
      ...
      direction = direction.concat(' L' + ' ' + (width - rX) + ' ' + startY + ' Q ' + width + ' ' + startY + ' ' + width + ' ' + (startY + rY) + ' L' + ' ' + width + ' ' + (arrowLocation.y - arrowPadding));
      direction = direction.concat(' L' + ' ' + (width + arrowPadding) + ' ' + tipY);
      direction = direction.concat(' L' + ' ' + width + ' ' + (arrowLocation.y + arrowPadding) + ' L' + ' ' + width + ' ' + (height - rY) + ' Q ' + width + ' ' + height + ' ' + (width - rX) + ' ' + height);
      direction = direction.concat(' L' + ' ' + (startX + rX) + ' ' + height + ' Q ' + startX + ' ' + height + ' ' + startX + ' ' + (height - rY) + ' z');
    } else {
      direction = direction.concat('M' + ' ' + (startX + rX) + ' ' + startY + ' Q ' + startX + ' ' + startY + ' ' + startX + ' ' + (startY + rY) + ' L' + ' ' + startX + ' ' + (arrowLocation.y - arrowPadding));
      direction = direction.concat(' L' + ' ' + (startX - arrowPadding) + ' ' + tipY);
      direction = direction.concat(' L' + ' ' + startX + ' ' + (arrowLocation.y + arrowPadding) + ' L' + ' ' + startX + ' ' + (height - rY) + ' Q ' + startX + ' ' + height + ' ' + (startX + rX) + ' ' + height);
  ...
  function (_super) {
    ...
    Tooltip.prototype.tooltipLocation = function (bounds, symbolLocation, arrowLocation, tipLocation) {
      ...
      if (!this.inverted) {
        ...
        if (bounds.width - (location.x + arrowLocation.x) < this.areaMargin + this.arrowPadding || location.x + arrowLocation.x < this.areaMargin + this.arrowPadding) {
        ...
        if (location.y + arrowLocation.y < this.areaMargin + this.arrowPadding || bounds.height - (location.y + arrowLocation.y) < this.areaMargin + this.arrowPadding) {
          this.outOfBounds = true;
        }
