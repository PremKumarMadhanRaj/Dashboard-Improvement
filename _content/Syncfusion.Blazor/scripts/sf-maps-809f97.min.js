...
window.sfBlazor.Maps = function () {
  ...
  function () {
    ...
    SfMaps.prototype.mouseUp = function (event) {
      ...
      if (!(id.indexOf('_Zooming_') > -1) && event.type !== 'mouseleave' && !this.isPinchZoomed && this.element.contains(event.target) && !sf.base.isNullOrUndefined(this.dotNetRef)) {
    ...
    SfMaps.prototype.mouseMove = function (event) {
      ...
      if (this.allowPanning && this.options.enablePanning && (this.clientX !== this.moveClientX || this.clientY !== this.moveClientY) && !this.isPinchZoomed) {
        this.isPanning = true;
    ...
    SfMaps.prototype.highlightMap = function (event) {
      ...
      if (!targetElement.classList.contains('highlightShape') && !targetElement.classList.contains('highlightMarker') && !targetElement.classList.contains('highlightBubble') && !targetElement.classList.contains('highlightNavigation')) {
        this.removeAllHighlight();
      }
    ...
    SfMaps.prototype.dataLabelTranslate = function (element, factor, x, y, scale, type) {
      ...
      if (type !== 'Template') {
        ...
        labelY = (labelY + y) * scale + currentLabel['BorderSize']['Height'] / 4;

        if (element.id.indexOf('_RectIndex_') > -1) {
          element.setAttribute('x', (labelX - parseInt(element.getAttribute('width')) / 2).toString());
          element.setAttribute('y', (labelY - padding + parseInt(element.getAttribute('height')) / 4).toString());
        } else {
    ...
    SfMaps.prototype.mergeSeparation = function () {
      if (this.markerClusterExpandCheck && this.sameMarkerData) {
    ...
    SfMaps.prototype.renderImages = function (canvasElement, tile, context, exportTileImg, tileElementCount, type, fileName, url, proxy, allowDownload) {
      return new Promise(function (resolve, reject) {
        exportTileImg.onload = function () {
          ...
          context.drawImage(exportTileImg, 0, 0, 256, 256);
  ...
  var Maps = {
    ...
    updateCollection: function updateCollection(element, collection) {
      if (element && element.blazor__instance) {
        ...
        element.blazor__instance.navigation = JSON.parse(collection.navigationLine);
