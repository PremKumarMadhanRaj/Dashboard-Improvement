...
window.sfBlazor.Gantt = function () {
  ...
  var Gantt = {
    ...
    tooltipOpened: function tooltipOpened(element, args) {
      element.blazor_instance.tooltipModule.tooltipOpened(args);
    },
    ChartInitialize: function ChartInitialize(element, contentHeight, totalTimelineWidth, milestoneHeight) {
      ...
      element.blazor_instance.tooltipModule = new Tooltip(element.blazor_instance);
    ...
    updateScrollLeft: function updateScrollLeft(element, scrollLeft, index) {
      var chartElement = element.querySelector('.e-chart-scroll-container');

      if (index != null) {
        var taskbarHeight = element.querySelector('.e-row').offsetHeight;
