...
window.sfBlazor.Grid = function () {
  ...
  function () {
    ...
    Scroll.prototype.removeUnwantedScroll = function (offsetValue) {
      ...
      if (offsetValue === "Height" && this.parent.content.offsetHeight >= this.parent.getContentTable().offsetHeight + movableScrollbarHeight) {
        return true;
      }
  ...
  function () {
    ...
    Freeze.prototype.setFrozenHeight = function () {
      ...
      if (this.parent.options.enableVirtualization && this.parent.options.enableColumnVirtualization && frozenscrollbarX) {
        ...
        var columnsList = this.parent.getColumns();

        if (this.parent.getRowHeight() <= 20 && columnsList.filter(function (args) {
          return args.type == "CheckBox";
        })) {
          var movableTable = movableContent.getElementsByClassName('e-table')[0];
          movableTable.style.height = frozenContentHeight - 1 + 'px';
        }
      ...
      if (this.parent.options.enableVirtualization && !this.parent.options.enableColumnVirtualization) {
        movableContent.style.width = this.parent.element.querySelector('.e-movableheader').offsetWidth - 1 + 'px';
      }
  ...
  function () {
    ...
    ColumnChooser.prototype.windowResized = function () {
      setTimeout(function () {
        if (Object.keys(this.mediaColVisibility).length > 0) {
          this.parent.dotNetRef.invokeMethodAsync('SetMediaColumnVisibility', {
            mediaColVisibility: this.mediaColVisibility,
            invokedByMedia: true
          });
  ...
  function () {
    ...
    Edit.prototype.createTooltip = function (results, isAdd) {
      ...
      var _loop_1 = function _loop_1() {
        ...
        if (this_1.parent.options.frozenColumns) {
          gcontent = this_1.parent.getContent().querySelector('.e-movablecontent');
        }

        var name_1 = results[i]['fieldName'];
        var message = results[i]['message'];
        name_1 = name_1.replace(/[.]/g, "___");
        var element = this_1.parent.element.querySelector("#" + name_1) || document.querySelector("#" + name_1);
        ...
        var fCont = this_1.parent.getContent().querySelector('.e-frozencontent');
        var isFHdr = void 0;
        ...
        if (isInline) {
          if (this_1.parent.options.frozenRows) {// TODO: FrozenRows
        ...
        var table = isInline ? isFHdr ? this_1.parent.getHeaderTable() : this_1.parent.getContentTable() : document.querySelector('#' + this_1.parent.element.id + '_dialogEdit_wrapper').querySelector('.e-dlg-content');
        ...
        var div = this_1.parent.element.querySelector("#" + name_1 + "_Error") || document.querySelector("#" + name_1 + "_Error");
        div.style.top = (isFHdr ? inputClient.top + inputClient.height : inputClient.bottom - client.top - (this_1.parent.options.frozenColumns ? fCont.scrollTop : 0)) + table.scrollTop + 9 + 'px';
        ...
        if (validationForBottomRowPos) {
          if (isScroll && !this_1.parent.options.frozenColumns && this_1.parent.options.height !== 'auto' && !this_1.parent.options.frozenRows //&& !this.parent.enableVirtualization
          ) {
            var scrollWidth = gcontent.scrollWidth > gcontent.offsetWidth ? getScrollBarWidth() : 0;
            div.style.bottom = parseInt(this_1.parent.options.height) - gcontent.querySelector('table').offsetHeight - scrollWidth + inputClient.height + 9 + 'px';
          } else {
  ...
  function () {
    ...
    VirtualContentRenderer.prototype.onDataReady = function () {
      ...
      if (this.parent.options.enableVirtualMaskRow) {
        ...
        if (yValue_1 == 0) yValue_1 = yValue_1 - this.parent.options.pageSize * (this.parent.options.rowHeight ? this.parent.options.rowHeight : this.parent.getRowHeight());else yValue_1 = yValue_1 - this.parent.options.pageSize * (this.parent.options.rowHeight ? this.parent.options.rowHeight : this.parent.getRowHeight()) - 10;
  ...
  function () {
    ...
    VirtualHelper.prototype.getColumnIndexes = function (content) {
      ...
      var cWidth = this.parent.options.needClientAction ? this.parent.options.frozenColumns && this.parent.options.enableColumnVirtualization ? this.parent.getHeaderContent().offsetWidth : content.getBoundingClientRect().width : Number(this.parent.options.width);
  ...
  function () {
    ...
    */
    ...
    SfGrid.prototype.documentClickHandler = function (e) {
      ...
      var filterClearTarget = parentsUntil(e.target, 'e-clear-icon');
      ...
      if (filterClearTarget && toolbar == null) {
        var targetId = parentsUntil(filterClearTarget, 'e-grid').id;

        if (targetId === this.element.id) {
          var filterBarId = filterClearTarget.parentElement.firstElementChild.id;
          var fieldName = filterBarId.split('_')[0];
          this.dotNetRef.invokeMethodAsync('FilterBarClear', fieldName);
        }
      }
    };
    ...
    SfGrid.prototype.keyDownHandler = function (e) {
      ...
      var isGridFocused = e.target.classList.contains("e-grid");
    ...
    SfGrid.prototype.clientActions = function () {
      if (this.options.enableVirtualization && (this.options.pageSize === 12 || this.options.width === 'auto' || this.options.width === '100%')) {
  ...
  var Grid = {
    ...
    contentReady: function contentReady(element, options, action) {
      if (!sf.base.isNullOrUndefined(element) && !sf.base.isNullOrUndefined(element.blazor__instance)) {
        ...
        if (instance.options.enablePersistence) {
