...
window.sfBlazor.Signature = function () {
  ...
  /** @class */
  function () {
    function SfSignature(element, parameter, dotnetRef) {
      this.element = element;
  ...
  var Signature = {
    initialize: function initialize(element, parameter, dotnetRef) {
      if (!sf.base.isNullOrUndefined(element)) {
        new SfSignature(element, parameter, dotnetRef);
        element.blazor__instance.signatureBase.initialize(element, dotnetRef);
      }
    },
    clear: function clear(element) {
      element.blazor__instance.signatureBase.clear();
    },
    undo: function undo(element) {
      element.blazor__instance.signatureBase.undo();
    },
    redo: function redo(element) {
      element.blazor__instance.signatureBase.redo();
    },
    save: function save(element, fileType, fileName) {
      switch (fileType) {
        case 0:
          element.blazor__instance.signatureBase.save("Png", fileName);
          break;

        case 1:
          element.blazor__instance.signatureBase.save("Jpeg", fileName);
          break;

        case 2:
          element.blazor__instance.signatureBase.save("Svg", fileName);
          break;
      }
    },
    draw: function draw(element, text, fontFamily, fontSize) {
      element.blazor__instance.signatureBase.draw(text, fontFamily, fontSize);
    },
    load: function load(element, signature, width, height) {
      element.blazor__instance.signatureBase.load(signature, width, height);
    },
    getSignature: function getSignature(element, type) {
      switch (type) {
        case 0:
          return element.blazor__instance.signatureBase.getSignature("Png");

        case 1:
          return element.blazor__instance.signatureBase.getSignature("Jpeg");

        case 2:
          return element.blazor__instance.signatureBase.getSignature("Svg");
      }
    ...
    onPropertyChanged: function onPropertyChanged(element, key, value) {
      element.blazor__instance.signatureBase.propertyChanged(key, value);
    },
    isEmpty: function isEmpty(element) {
      return element.blazor__instance.signatureBase.isEmpty();
    },
    canUndo: function canUndo(element) {
      return element.blazor__instance.signatureBase.canUndo();
    },
    canRedo: function canRedo(element) {
      return element.blazor__instance.signatureBase.canRedo();
    },
    destroy: function destroy(element) {
      element.blazor__instance.signatureBase.destroy();
    }
  };
  return Signature;
}();
