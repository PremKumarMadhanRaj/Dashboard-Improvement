...
window.sf.officechart = function (exports) {
  ...
  function () {
    ...
    ChartComponent.prototype.writeChartSeries = function (seriesData, data, type, count) {
      ...
      var seriesFormat = seriesData.dataPoints[count];
      var series = {};
      var fill;
      ...
      if (this.isPieType) {
        ...
        if (!sf.base.isNullOrUndefined(seriesFormat.fill.foreColor)) {
          series.pointColorMapping = 'color';
        }
      }
    ...
    ChartComponent.prototype.chartPlotData = function (data, chart, type, count) {
      ...
      for (var j = 0; j < series.length; j++) {
        ...
        if (chart.chartType === 'Pie' || chart.chartType === 'Doughnut' || chart.chartType === 'Column_Stacked') {
          ...
          var seriesDataPoints = seriesData.dataPoints.find(function (obj) {
            return obj.id === count;
          });
          ...
          if (!sf.base.isNullOrUndefined(seriesDataPoints)) {
            ...
            if (!sf.base.isNullOrUndefined(seriesData.seriesFormat) && !sf.base.isNullOrUndefined(seriesData.seriesFormat.fill)) {
