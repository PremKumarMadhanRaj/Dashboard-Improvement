...
/******/ 		return __webpack_require__.p + "" + ({"sf-import":"sf-import","sf-import-ie":"sf-import-ie"}[chunkId]||chunkId) + "-" + "809f97" + ".min.js"
/******/ 	}
/******/
...
window.sf.base = function (exports) {
  ...
  function (_super) {
    ...
    Draggable.prototype.changeElementStyle = function (evt) {
      if (this.helperElement && evt.changedTouches) {
        var DivElements = this.helperElement.parentNode.getElementsByTagName('DIV');
        var ULElements = this.helperElement.parentNode.getElementsByTagName('UL');

        for (var i = 0; i < DivElements.length; i++) {
          if (DivElements[i].className === 'e-content') {
            if (DivElements[i].style.overflow === 'hidden') {
              setStyleAttribute(DivElements[i], {
                overflow: ''
              });
            } else {
              setStyleAttribute(DivElements[i], {
        ...
        for (var i = 0; i < ULElements.length; i++) {
          if (ULElements[i].className === 'e-list-parent') {
            if (ULElements[i].style.overflow === 'hidden') {
              setStyleAttribute(ULElements[i], {
                overflow: ''
              });
            } else {
              setStyleAttribute(ULElements[i], {
