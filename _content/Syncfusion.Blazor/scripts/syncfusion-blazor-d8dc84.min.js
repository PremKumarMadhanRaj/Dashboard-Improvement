...
/******/ 		return __webpack_require__.p + "" + ({"sf-import":"sf-import","sf-import-ie":"sf-import-ie"}[chunkId]||chunkId) + "-" + "d8dc84" + ".min.js"
/******/ 	}
/******/
...
window.sf.base = function (exports) {
  ...
  function (_super) {
    ...
    Component.prototype.appendReactElement = function (element, container) {//No Code
    }; //tslint:disable-next-line
